...
/**
 * <p>
 * Use {//@link TODO: Fix link for sanity.
 * KuduTableMapReduceUtil.TableOutputFormatConfigurator}
 * to correctly setup this output format, then {//@link TODO: Fix link for sanity.
 * KuduTableMapReduceUtil#getTableFromContext(org.apache.hadoop.mapred.TaskInputOutputContext)}
 * to get a KuduTable.
 * </p>
 *
 * <p>
 ...
 * {@link #checkOutputSpecs(FileSystem, JobConf)}
 * or {@link TableRecordWriter#close(Reporter)}
 * have been called that the object won't be used again and the KuduClient is shut down.
 * </p>
 */
@InterfaceAudience.Public
@InterfaceStability.Evolving
public class KuduTableOutputFormat implements OutputFormat<NullWritable,Operation>, Configurable {
    ...
    //TODO: I changed this to Public. Need to implement MULTITON to get table from there.
    ...
    @Override
    public RecordWriter<NullWritable, Operation> getRecordWriter(FileSystem fileSystem, JobConf jobConf, String s, Progressable progressable)
            throws IOException {
    ...
    protected class TableRecordWriter implements RecordWriter<NullWritable, Operation> {
